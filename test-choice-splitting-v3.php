<?php
/**
 * Test Script: Test choice splitting with marker handling
 */
...
echo "========================================\n";
echo "  CHOICE SPLITTING WITH MARKERS\n";
echo "========================================\n\n";
...
function splitChoicesOnLine($text) {
    ...
    foreach ($lines as $line) {
        ...
        // Check if line starts with a choice letter
        if (!preg_match('/^[a-d]\.\s+/', $line)) {
            $processedLines[] = $line;
            continue;
        }
        
        // Try to split by multiple spaces (2 or more) between choices
