...
// Test AI DOCX Import using PHP
echo "========================================\n";
echo "  AI DOCX IMPORT TEST (PHP)\n";
echo "========================================\n\n";
...
$docxPath = __DIR__ . '/Aquaculture_set A.docx';
if (!file_exists($docxPath)) {
    die("      FAILED - Aquaculture_set A.docx not found\n");
}

$ch = curl_init("$baseUrl/admin/questions/import-docx");
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, [
    'file' => new CURLFile($docxPath, 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'Aquaculture_set A.docx'),
