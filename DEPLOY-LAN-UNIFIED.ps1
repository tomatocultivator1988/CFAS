...
if ($ipAddress) {
    Write-Host "✓ LAN IP detected: $ipAddress" -ForegroundColor Green
} else {
...
Write-Host "  ✓ Detect LAN environment" -ForegroundColor White
Write-Host "  ✓ Use correct API endpoint (http://$ipAddress:8000/api)" -ForegroundColor White
Write-Host "  ✓ Load all images correctly" -ForegroundColor White
Write-Host "  ✓ Handle routing properly" -ForegroundColor White
Write-Host ""
