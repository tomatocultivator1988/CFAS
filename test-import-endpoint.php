...
$testFile = __DIR__ . '/Sample_Questions.docx';

if (!file_exists($testFile)) {
    die("ERROR: Test file not found: $testFile\n");
}

echo "Uploading test file to exam 91...\n";
echo "File: Sample_Questions.docx\n";
...
// Now check if questions were added to exam 91
echo "\n========================================\n";
...
$count92 = DB::table('exam_questions')->where('exam_id', 92)->count();

echo "Exam 91 questions: $count91\n";
echo "Exam 92 questions: $count92\n";
echo "========================================\n";
